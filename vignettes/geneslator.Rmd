...
knitr::opts_chunk$set(
  collapse = TRUE, comment = "#>", warning = FALSE,
  message = FALSE
)
```
...
-   **Multi-organism support**: Integrates annotation data from several model 
    organisms into a unique R package.

**geneslator** currently supports 14 different organisms, including Human, 
Mouse, Rat, Yeast, Worm, Fly, Zebrafish, Arabidopsis and other plant species.
In the future releases of the package, the number of supported species will 
increase to include more model organisms.
